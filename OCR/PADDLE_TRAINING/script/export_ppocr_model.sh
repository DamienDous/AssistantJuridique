...
if [ -f "$OUTPUT_DIR/PP-OCRv5_det_infer/inference.pdmodel" ]; then
...
python3 tools/export_model.py \
  ...
  -o Global.pretrained_model=./pretrain_models/PP-OCRv5_server_det_pretrained.pdparams \
  -o Global.save_inference_dir=$OUTPUT_DIR/PP-OCRv5_server_det

# Vérifie que tout est bien exporté
echo "✅ Modèle exporté dans $OUTPUT_DIR/PP-OCRv5_det_infer"
ls -lh $OUTPUT_DIR/PP-OCRv5_det_infer
